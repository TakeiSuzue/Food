...
if(isset($_POST['submit'])){
   ...
   $fetch_prev_pass = $select_old_pass->fetch();
...
<!-- khu vực cập nhật hồ sơ admin bắt đầu -->
...
<section class="form-container">
   ...
   <?php
      ...
      // Lấy thông tin admin hiện tại để hiển thị placeholder
...
<!-- khu vực cập nhật hồ sơ admin kết thúc -->
