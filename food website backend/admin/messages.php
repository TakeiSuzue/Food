...
<section class="messages">
   ...
   <div class="box">
      ...
      <p> Nội dung : <span><?= $fetch_messages['message']; ?></span> </p>
      <a href="messages.php?delete=<?= $fetch_messages['id']; ?>" class="delete-btn" onclick="return confirm('Bạn có chắc muốn xóa tin nhắn này không?');">Xóa</a>
   </div>
   <?php
         }
      }else{
...
<!-- phần tin nhắn kết thúc -->

<!-- liên kết js tuỳ chỉnh -->
