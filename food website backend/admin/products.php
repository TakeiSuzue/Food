...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="bun">Bánh bao</option>
         <option value="donut">Bánh nướng</option>
         <option value="cookies">Bánh quy</option>
         <option value="cake">Bánh kem</option>
         <option value="pastry">Bánh ngàn lớp</option>
         <option value="dessert">Bánh lạnh</option>
      </select>
...
<!-- phần thêm sản phẩm kết thúc -->

<!-- phần hiển thị sản phẩm bắt đầu -->
...
<!-- phần hiển thị sản phẩm kết thúc -->
