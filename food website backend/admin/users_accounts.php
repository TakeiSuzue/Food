...
<!-- khu vực tài khoản người dùng bắt đầu -->
...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" class="delete-btn" onclick="return confirm('Bạn có chắc muốn xóa tài khoản này không?');">Xóa</a>
   </div>
   <?php
      }
   }else{
...
<!-- khu vực tài khoản người dùng kết thúc -->
